...
class ProfController extends Controller
{
  ...
  try {
        ...
        return redirect()->route('list.seance')->with(['success' => 'Séance est ajouté avec succès']);
...
// fonction permet d'afficher la liste des seances de l'ensaignant courant ayant le champ 'active=0'
    ...
    public function editSeance($id)
    {
        ...
        return view('Enseignant.update',['seance'=>$seance,"matieres"=>$matieres,'id_prof'=>$id_prof]);
    }
  ...
  try {
        ...
        return redirect()->route('list.seance')->with(['success' => 'Séance est modifié avec succès']);
